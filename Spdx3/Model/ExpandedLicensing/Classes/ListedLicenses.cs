...
public class ListedLicenses
{
    private static readonly CreationInfo _creationInfo =
        new(new Catalog(),
                DateTimeOffset.ParseExact("2025-05-31T19:32:01.0511290+00:00", "o", new DateTimeFormatInfo()))
    ...
    public static readonly Dictionary<string, ListedLicense> Licenses = new Dictionary<string, ListedLicense>
    { 
        { "0BSD", _0BSD },

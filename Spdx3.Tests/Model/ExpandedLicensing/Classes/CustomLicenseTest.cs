...
public class CustomLicenseTest : BaseModelTest
{
    ...
    {
        // Arrange
        var license = new CustomLicense(TestCatalog, TestCreationInfo, "test license text");
    ...
    {
        // Arrange
        var license = new CustomLicense(TestCatalog, TestCreationInfo, "TestLicenseText")
        {
            Comment = "TestComment",
